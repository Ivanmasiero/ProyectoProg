...
public class InterfazCollection {
    public static void main(String[] args) {
        ...
        System.out.println("La colección2 contiene: "+coleccion2);
        ...
        System.out.println("La colección2 tiene los mismos elementos que colección: "+coleccion.containsAll(coleccion2));
        ...
        System.out.println("La colección ahora tiene estos elementos: "+coleccion);
        ...
        System.out.println("Después de hacer el borrado la colección contiene: "+coleccion);
        ...
        System.out.println("La colección ahora contiene: "+coleccion);
        //Usamos el metodo .clear con la colección2 para quitar todos los elementos de la colección.
        coleccion2.clear();
        System.out.println("Después de usar clear la colección2 contiene: "+coleccion2);
        //Por último vamos a comprobar con .isEmpty si la colección esta vacía.
        System.out.println("¿La colección2 está vacía? "+coleccion2.isEmpty());
    }
}
